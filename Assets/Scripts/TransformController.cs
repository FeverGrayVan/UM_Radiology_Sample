...
namespace VolumeRendering.Utils
{
    public class TransformController : MonoBehaviour 
    {
        ...
        protected bool freeRotation = true;
        ...
        {
            targetRotation = new Quaternion(90,0,0,0);
            var dt = Time.deltaTime;
            Rotate(dt*100);
            freeRotation = false;
        }
        ...
        {
            targetRotation = Quaternion.Euler(90,-225,45);
            var dt = Time.deltaTime;
            Rotate(dt*100);
            freeRotation = false;
        }
        ...
        {
            targetRotation = Quaternion.Euler(90,45,225);
            var dt = Time.deltaTime;
            Rotate(dt*100);
            freeRotation = false;
        }
