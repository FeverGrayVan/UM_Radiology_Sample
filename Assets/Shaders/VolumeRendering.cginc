...
float sample_volume(float3 uv, float3 p)
{
    ...
    //float min = _SliceMin.x * _SliceMin.y * _SliceMin.z;
    //float max = _SliceMax.x * _SliceMax.y * _SliceMax.z;
...
v2f vert(appdata v)
{
    ...
    o.cullerpos = mul(_CullerSpace, o.world);
    return o;
}
